package dev.abdujabbor.firebasedeleteperson
...
import dev.abdujabbor.firebasedeleteperson.databinding.ActivityMainBinding
import dev.abdujabbor.firebasedeleteperson.utils.MyConstants
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.etTo.adapter = adapter
        binding.etFrom.adapter = adapter
        binding.etFrom.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
        ...
        binding.etTo.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                parent: AdapterView<*>?, view: View?, position: Int, id: Long
            ) {
                val selectedItem = parent?.getItemAtPosition(position).toString()
